...
;This script converts a joystick into a three-button mouse.
;It allows each button to drag just like
;a mouse button and it uses virtually
;no CPU time. Also, it will move the
;cursor faster depending on how far
;you push the joystick from center.
;You can personalize various settings
